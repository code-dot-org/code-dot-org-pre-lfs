...
export default class SvgFrame {
  element_: BlockSvg | WorkspaceSvg;
  text: string;
  className: string;
  getColor: () => string;
  headerColor: string;
  ...
  headerHeight: number;
  fontSize: number;
  frameGroup_: SVGElement | undefined;
  frameClipRect_: SVGElement | undefined;
  frameBase_: SVGElement | undefined;
  frameHeader_: SVGElement | undefined;
  frameText_: SVGElement | undefined;
  ...
  render(width?: number, height?: number) {
    ...
    let svgGroup;
    if (this.element_ instanceof BlockSvg) {
      svgGroup = this.element_.getSvgRoot();
    } else {
      svgGroup = this.element_.svgGroup_;
    }
